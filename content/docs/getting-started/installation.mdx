---
title: "Installation"
description: "RimZ is a single binary for macOS and Linux. Pick one install path: the install script, Homebrew on macOS, a prebuilt binary from the releases page, or Cargo."
---
