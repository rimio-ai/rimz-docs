---
title: "Agents"
description: "RimZ watches the agents you already run. Type claude into any pane and it joins the room; rimz agents earns its keystrokes later, when you want an agent tuned for one…"
---
