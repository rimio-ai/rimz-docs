---
title: "Budgets"
description: "You already cap spend where the provider lets you: a billing alert on the API dashboard, a plan whose included usage refills on a window. Those guard the account."
---
...
- [Providers internals](https://github.com/rimio-ai/rimz/blob/v0.4.2/docs/internals/agents/providers.md?ref=docs) — spend windows, ledgers, and park mechanics in depth.
