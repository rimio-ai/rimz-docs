...
| **Run and steer agents** | `agents`, `asks`, `answer`, `message`, `transcript`, `pane`, `events` | [Agents](/docs/reference/cli/agents) · [Asks](/docs/reference/cli/asks) · [Message](/docs/reference/cli/message) · [Transcript](/docs/reference/cli/transcript) · [Pane](/docs/reference/cli/pane) · [Events](/docs/reference/cli/events) |
...
**Addressing agents.** `message`, `transcript`, `pane`, and the `agents` management verbs all name agents the same way: `@<handle>` for who, `#<channel>` for which named lane, worktree, or in-place team, or a raw pane id. The one canonical explanation is [Addressing agents](/docs/reference/cli/agents#addressing-agents).
