...
| **Cost, usage, and budgets** | `stats`, `budget` | [Stats](/docs/reference/cli/stats) · [Budgets](/docs/reference/cli/agents#inspect-and-change-a-budget) |
...
| **Maintain and recover** | `coverage`, `workspace`, `reload`, `reset`, `gc`, `uninstall`, `ping` | [Maintenance](/docs/reference/cli/maintenance) |
