---
title: "Loop CLI"
description: "rimz loop puts agent turns on a clock. A task is a durable schedule: rimz loop add writes recurring machine tasks to loop.toml, writes project tasks to the repo's…"
---
...
The task model and config shape are in [loops.md](https://github.com/rimio-ai/rimz/blob/v0.4.2/docs/internals/harness/loops.md?ref=docs).
