---
title: "Remote CLI"
description: "rimz remote attaches to a room on another host over SSH. remote connect builds a guarded ssh -t command on your machine and runs the remote host's own rimz, so your…"
---
...
Link health, web tunneling, and reconnect mechanics are in [remote internals](https://github.com/rimio-ai/rimz/blob/v0.4.2/docs/internals/remote.md?ref=docs).
