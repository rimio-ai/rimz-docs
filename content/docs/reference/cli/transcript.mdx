...
For an agent-centric tail that follows new lines as they land, [`rimz agents logs <ref>`](/docs/reference/cli/agents#logs) uses this same transcript scope and rendering.
