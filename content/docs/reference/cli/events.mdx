---
title: "`rimz events`"
description: "rimz events follow streams each durable agent lifecycle transition as one JSON object per line, for harnesses that react to agent state without scraping panes or…"
---
