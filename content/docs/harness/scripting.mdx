---
title: "Scripting"
description: "rimz agents -p is claude -p for every agent RimZ supports: one prompt, one supervised turn, one exit code — with the turn running in a real pane you can watch, answer…"
---
