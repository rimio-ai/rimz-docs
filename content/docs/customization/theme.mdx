...
Every element carries its state by shape first (the [glyph legend](https://github.com/rimio-ai/rimz/blob/v0.4.2/docs/interface/sidebar.md?ref=docs#reading-the-glyphs) is the meaning table), so color reinforces meaning rather than carrying it, and any palette stays readable, including no color at all. This page is the knobs; [interface/sidebar.md](https://github.com/rimio-ai/rimz/blob/v0.4.2/docs/interface/sidebar.md?ref=docs) is what every tone and glyph *means* on screen.
