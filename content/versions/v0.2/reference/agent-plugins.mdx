...
The complete runnable [ScriptBot example](https://github.com/rimio-ai/rimz/blob/v0.2/examples/agent-plugin/README.md?ref=docs) supplies a fake agent, canonical shim, priced spend probe, account probe, and fixture transcript.
