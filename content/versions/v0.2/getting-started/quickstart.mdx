...
Hooks install on first `rimz` run, with consent and a diff preview. The [sidebar guide](/docs/v0.2/agents/sidebar) shows what happens after the room opens.
...
Deep dive: [Agent control CLI](/docs/v0.2/reference/cli/agents).
...
Deep dive: [RimZ-owned worktrees](/docs/v0.2/harness/worktrees).
...
Deep dive: [Configuration](/docs/v0.2/customization/configuration#agent-profiles-commands-and-teams).
...
Deep dive: [Teams and resume](/docs/v0.2/harness/teams).
...
Deep dive: [Messaging](/docs/v0.2/harness/messaging).
...
Deep dive: [Scripting](/docs/v0.2/harness/scripting).
...
Deep dive: [Set up your machine](/docs/v0.2/getting-started/setup#keep-the-fleet-moving).
...
Deep dive: [Remote attach](/docs/v0.2/agents/remote) and [Web access](/docs/v0.2/agents/web).
...
Deep dive: [Remote control](/docs/v0.2/agents/remote#answer-asks-from-your-phone).
