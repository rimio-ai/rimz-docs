...
Configure public URL prefixes under `[web.zellij]` and `[web.tmux]`; see the [web guide](/docs/v0.4/agents/web) and [configuration guide](/docs/v0.4/customization/configuration#web-access).
