...
<p align="center">
  <img src="/docs-assets/v0.4/rimz-full.png" alt="A RimZ room: the sidebar triaging a fleet of coding agents beside their panes" width="100%"/>
...
RimZ is **alpha software**, moving fast. Expect rough edges and the occasional bug, and expect the surface to shift: commands, flags, config keys, and output formats can change between releases while the design settles. The [changelog](https://github.com/rimio-ai/rimz/blob/v0.4/CHANGELOG.md?ref=docs) records what moved in each release.
...
<p align="center">
  <img src="/docs-assets/v0.4/rimz-gallery.png" alt="" width="100%"/>
...
→ [DESIGN.md](https://github.com/rimio-ai/rimz/blob/v0.4/DESIGN.md?ref=docs) · [ARCHITECTURE.md](https://github.com/rimio-ai/rimz/blob/v0.4/ARCHITECTURE.md?ref=docs)
...
The per-mechanism detail and permission-mode mapping live in [agent support](/docs/v0.4/reference/agent-support), and `rimz coverage` prints the live grid on your own machine with a reason on every cell.
...
- [Quickstart](/docs/v0.4/getting-started/quickstart) gives the five-step path from install to a working fleet.
- [Working with agents](/docs/v0.4/agents/fleet) covers layouts, profiles, teams, and the running fleet.
- [Token insight](/docs/v0.4/agents/insight) explains live cost, historical usage, and provider budget windows.
- [Set up your machine](/docs/v0.4/getting-started/setup) covers hooks, color, pets, and multiplexer baselines.
- [The sidebar](/docs/v0.4/agents/sidebar) documents rendered frames and the glyph legend.
- [CLI reference](/docs/v0.4/reference/cli), [agent support](/docs/v0.4/reference/agent-support), and [configuration](/docs/v0.4/customization/configuration) cover the exact command, integration, and setting surfaces.
