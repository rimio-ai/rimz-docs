...
- [Remote](/docs/v0.4/agents/remote) — saved aliases and reconnect behavior.
- [Web CLI reference](/docs/v0.4/reference/cli/web) — every subcommand and flag.
- [Configuration](/docs/v0.4/customization/configuration#web-access) — per-machine settings.
- [Web internals](https://github.com/rimio-ai/rimz/blob/v0.4/docs/internals/web.md?ref=docs) — state files, ports, and remote relay.
- [Troubleshooting](/docs/v0.4/help/troubleshooting) — missing engines and failed starts.
