...
Configure public URL prefixes under `[web.zellij]` and `[web.tmux]`; see the [web guide](/docs/main/agents/web) and [configuration guide](/docs/main/customization/configuration#web-access).
