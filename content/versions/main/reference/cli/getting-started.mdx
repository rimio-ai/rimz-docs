...
- **Backend** — backend and version, PATH-visible backend binaries, scoped and grouped logical server-log issues, accepted Zellij plugin-generation telemetry, server socket, session health, duplicate sidebars
