...
| **Cost, usage, and budgets** | `stats`, `providers`, `budget` | [Stats](/docs/main/reference/cli/stats) · [Providers](/docs/main/reference/cli/providers) · [Budgets](/docs/main/reference/cli/agents#inspect-and-change-a-budget) |
...
| **Maintain and recover** | `coverage`, `workspace`, `update`, `reload`, `reset`, `gc`, `uninstall`, `ping` | [Maintenance](/docs/main/reference/cli/maintenance) |
