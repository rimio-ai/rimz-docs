...
<p align="center">
  <img src="/docs-assets/main/rimz-full.png" alt="A RimZ room: the sidebar triaging a fleet of coding agents beside their panes" width="100%"/>
...
RimZ is **alpha software**, moving fast. Expect rough edges and the occasional bug, and expect the surface to shift: commands, flags, config keys, and output formats can change between releases while the design settles. The [changelog](https://github.com/rimio-ai/rimz/blob/main/CHANGELOG.md?ref=docs) records what moved in each release.
...
<p align="center">
  <img src="/docs-assets/main/rimz-gallery.png" alt="" width="100%"/>
...
→ [DESIGN.md](https://github.com/rimio-ai/rimz/blob/main/DESIGN.md?ref=docs) · [ARCHITECTURE.md](https://github.com/rimio-ai/rimz/blob/main/ARCHITECTURE.md?ref=docs)
...
The per-mechanism detail and permission-mode mapping live in [agent support](/docs/main/reference/agent-support), and `rimz coverage` prints the live grid on your own machine with a reason on every cell.
...
- [Quickstart](/docs/main/getting-started/quickstart) gives the five-step path from install to a working fleet.
- [Working with agents](/docs/main/agents/fleet) covers layouts, profiles, teams, and the running fleet.
- [Token insight](/docs/main/agents/insight) explains live cost, historical usage, and provider budget windows.
- [Set up your machine](/docs/main/getting-started/setup) covers hooks, color, pets, and multiplexer baselines.
- [The sidebar](/docs/main/agents/sidebar) documents rendered frames and the glyph legend.
- [CLI reference](/docs/main/reference/cli), [agent support](/docs/main/reference/agent-support), and [configuration](/docs/main/customization/configuration) cover the exact command, integration, and setting surfaces.
