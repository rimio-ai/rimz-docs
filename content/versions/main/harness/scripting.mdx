...
- [scripting.md](https://github.com/rimio-ai/rimz/blob/main/docs/internals/harness/scripting.md?ref=docs) — run records, the wakeup socket, streaming, and pane cleanup.
