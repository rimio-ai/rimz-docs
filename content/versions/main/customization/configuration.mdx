...
The rebirth path is in [sidebar.md](https://github.com/rimio-ai/rimz/blob/main/docs/internals/sidebar/sidebar.md?ref=docs#resume-on-rebirth) and the live path in [provider.md → Auto-continue](https://github.com/rimio-ai/rimz/blob/main/docs/internals/agents/providers.md?ref=docs#auto-continue).
