...
Hooks install on first `rimz` run, with consent and a diff preview. The [sidebar guide](/docs/main/agents/sidebar) shows what happens after the room opens.
...
Deep dive: [Agent control CLI](/docs/main/reference/cli/agents).
...
Deep dive: [RimZ-owned worktrees](/docs/main/harness/worktrees).
...
Deep dive: [Configuration](/docs/main/customization/configuration#agent-profiles-commands-and-teams).
...
Deep dive: [Teams and resume](/docs/main/harness/teams).
...
Deep dive: [Messaging](/docs/main/harness/messaging).
...
Deep dive: [Scripting](/docs/main/harness/scripting).
...
Deep dive: [Set up your machine](/docs/main/getting-started/setup#keep-the-fleet-moving).
...
Deep dive: [Remote attach](/docs/main/agents/remote) and [Web access](/docs/main/agents/web).
...
Deep dive: [Remote control](/docs/main/agents/remote#answer-asks-from-your-phone).
