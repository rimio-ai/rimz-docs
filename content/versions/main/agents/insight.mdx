...
- **Assists** tell the helped-you story for the window: completed budget-window pings and their cost, reset-credit attempts and successful resets, delivered auto-continues and the time recovered between park and resume, followed by the five newest events. The section stays absent until RimZ has an assist to report.
